...
public interface MainMapperInter {
   ...
   public List<MainTO> DefaultDataForMain(String mId);
	...
	@Select("SELECT m.*, i.i_kcal, i.i_weight, i.i_day, i.i_used_kcal FROM Member m INNER JOIN IntakeData i ON m.m_seq = i.m_seq WHERE m.m_id = 'test' and i.i_day= #{i_day};")
	public List<MainTO> DataFromDateForMain(@RequestParam("i_day") String i_day);
