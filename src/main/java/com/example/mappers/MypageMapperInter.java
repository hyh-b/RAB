...
//   public MypageTO mypage(MypageTO to);
   ...
   @Select(" SELECT m_id FROM Member WHERE m_id ='jihyeon' ")
   public MypageTO mypageModify(MypageTO to);
   
   
// ----------------------- ModifyOK -------------------------------------
// 조회
//   @Select("select m_id, m_profilename, m_backgroundfilename from album where m_id = #{m_id}")
//   public abstract MypageTO mypageModify_ok_select_parentInfo (MypageTO to);
   
   @Select("select m_id, m_profilename, m_backgroundfilename from album where m_id = 'jihyeon'")
   public abstract MypageTO mypageModify_ok_select_parentInfo (MypageTO to);
