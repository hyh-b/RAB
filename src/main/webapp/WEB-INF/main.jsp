                ...
                <div class="mt-4 flex items-end justify-between">
                  <div>
                   ...
                   ${i_day}
                    ...
                    <span class="text-sm font-medium"><a href="calendar.do">날짜를 선택하세요</a></span>
                  </div>
