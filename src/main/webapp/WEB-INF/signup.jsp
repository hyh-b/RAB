              ...
              <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                  ...
                  <form action="signup_ok.do" method="post" name="sfrm">
                    <div class="mb-4">
                      <label class="mb-2.5 block font-medium text-black dark:text-white">Id</label>
                      <div class="relative">
                        <input type="text" placeholder="Enter your full name" id="id" name="id" 
                    ...
                    <div class="mb-4">
                      ...
                      <div class="relative">
                        <input type="email" placeholder="Enter your email" name="mail" value=""
                          class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                    ...
                    <div class="mb-6">
                      ...
                      <div class="relative">
                        <input type="password" placeholder="Re-enter your password" name="r_password" value=""
                          class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                    ...
                    <!-- <button class="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 font-medium text-white transition hover:bg-opacity-90" >회원가입</button> -->
                       <input type="button" id="sbtn" value="Create account"
...
<script type="text/javascript">
	window.onload = function() {
		...
		document.getElementById( 'sbtn' ).onclick = function() {
			...
			//alert('Hello11');
			//alert(document.sfrm.id.value.trim());
			 if( document.sfrm.id.value.trim() == '' ) {
				alert( 'id를 입력하셔야 합니다' );
				return false;
			}
