...
>
  ...
  <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
    <a href="/">
      <img src="src/images/logo/rab.svg" alt= "logo가 들어가야 합니다."/>
    </a>
...
<!-- 					 <div class="rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5"> -->
					   <div class="mb-3 justify-between gap-4 sm:flex"></div>
					 <div id="chartstacked" class="mx-auto flex justify-center"></div>
<!-- 				   </div> -->
<!-- 				 </div> -->
			  </div>
		   </div>
