          ...
          <div class="flex flex-col gap-9">
            <div
              ...
              <div x-data="
                      ...
                      " class="mb-14 p-7.5 w-full">
                <div
                  class="mb-7.5 flex flex-wrap gap-3 rounded-lg border border-stroke py-3 px-4 dark:border-strokedark">
                  <a href="#" @click.prevent="openTab = 1" :class="openTab === 1 ? activeClasses : inactiveClasses"
                    class="rounded-md py-3 px-4 text-sm font-medium hover:bg-primary hover:text-white dark:hover:bg-primary md:text-base lg:px-6">
                    Home
                  </a>
                  <a href="#" @click.prevent="openTab = 2" :class="openTab === 2 ? activeClasses : inactiveClasses"
                    class="rounded-md py-3 px-4 text-sm font-medium hover:bg-primary hover:text-white dark:hover:bg-primary md:text-base lg:px-6">
                    About Us
                  </a>
                  <a href="#" @click.prevent="openTab = 3" :class="openTab === 3 ? activeClasses : inactiveClasses"
                    class="rounded-md py-3 px-4 text-sm font-medium hover:bg-primary hover:text-white dark:hover:bg-primary md:text-base lg:px-6">
                    Our Team
                  </a>
                  <a href="#" @click.prevent="openTab = 4" :class="openTab === 4 ? activeClasses : inactiveClasses"
                    class="rounded-md py-3 px-4 text-sm font-medium hover:bg-primary hover:text-white dark:hover:bg-primary md:text-base lg:px-6">
                    Company Details
                  </a>
                </div>
                <div>
                  ...
                  <div x-show="openTab === 3" class="font-medium leading-relaxed" style="display: none">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Officia nisi, doloribus nulla cumque molestias corporis
                    eaque harum vero! Quas sit odit optio debitis nulla
                  ...
                  <div x-show="openTab === 4" class="font-medium leading-relaxed" style="display: none">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Officia nisi, doloribus nulla cumque molestias corporis
                    eaque harum vero! Quas sit odit optio debitis nulla
                    quisquam, dolorum quaerat animi iusto quod.
            ...
            <div
              ...
              <div x-data="
                      ...
                      " class="mb-14 p-7.5 w-full">
                <div class="mb-7.5 flex flex-wrap gap-3 border-b border-stroke pb-5 dark:border-strokedark">
                  <a href="#" @click.prevent="openTab = 1" :class="openTab === 1 ? activeClasses : inactiveClasses"
                    class="rounded-md py-3 px-4 text-sm font-medium hover:bg-primary hover:text-white dark:hover:bg-primary md:text-base lg:px-6">
                    Home
                  </a>
            ...
            <div
              ...
              <div x-data="
                ...
                <div>
                  ...
                  <div x-show="openTab === 5" class="font-medium leading-relaxed" style="display: none">
                    Tab5 Lorem ipsum dolor sit amet, consectetur adipisicing
                    elit. Officia nisi, doloribus nulla cumque molestias
                    corporis eaque harum vero! Quas sit odit optio debitis
                    nulla quisquam, dolorum quaerat animi iusto quod.
                  </div>
                  <div x-show="openTab === 6" class="font-medium leading-relaxed" style="display: none">
