...
<head>
  ...
  <title>Inbox | TailAdmin - Tailwind CSS Admin Dashboard Template</title>
<link rel="icon" href="favicon.ico"><link href="style.css" rel="stylesheet"></head>

<body
  x-data="{ page: 'inbox', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
  x-init="
        ...
        <div class="mx-auto h-[calc(100vh-80px)] max-w-screen-2xl p-4 md:p-6 2xl:p-10">
          ...
          <div class="h-[calc(100vh-186px)] overflow-hidden sm:h-[calc(100vh-174px)]">
            <div x-data="{inboxSidebarToggle: false}"
              ...
              <div :class="inboxSidebarToggle && '!translate-x-0'"
                class="fixed top-22.5 bottom-0 z-999 flex w-[230px] -translate-x-[120%] flex-col rounded-md border border-stroke bg-white duration-300 ease-linear dark:border-strokedark dark:bg-boxdark lg:static lg:w-1/5 lg:translate-x-0 lg:border-none">
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div x-data="{openDropDown: false}" class="relative text-right">
                      ...
                      <div x-show="openDropDown" @click.outside="openDropDown = false"
                        ...
                        <button
                          class="w-full rounded py-2 px-3 text-left text-sm hover:bg-gray-2 dark:hover:bg-graydark">
                          Edit
                        </button>
                        <button
                          class="w-full rounded py-2 px-3 text-left text-sm hover:bg-gray-2 dark:hover:bg-graydark">
