...
<head>
  ...
  <title>Cards | TailAdmin - Tailwind CSS Admin Dashboard Template</title>
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <div class="flex items-center gap-3 py-5 px-6">
                ...
                <div>
                  ...
                  <p class="font-medium text-xs">Content Writer</p>
                </div>
              </div>
          ...
          <div class="grid grid-cols-1 gap-7.5 sm:grid-cols-2 xl:grid-cols-3">
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <a href="#" class="block px-4 pt-4">
                <img src="src/images/cards/cards-04.png" alt="Cards" />
              </a>
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <a href="#" class="block px-4 pt-4">
                <img src="src/images/cards/cards-05.png" alt="Cards" />
              </a>
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <a href="#" class="block px-4 pt-4">
                <img src="src/images/cards/cards-06.png" alt="Cards" />
              </a>
